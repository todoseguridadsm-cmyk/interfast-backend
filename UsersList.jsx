            ...
            <form onSubmit={handleSave} className="p-6 space-y-5">
              <div>
                ...
                <input 
                  ...
                  className={`w-full px-4 py-2 border rounded-xl outline-none ${editingId ? 'bg-slate-100 text-slate-500 cursor-not-allowed' : 'focus:ring-2 focus:ring-blue-500'}`} 
                  placeholder="ej: luis" 
                />
              </div>
              ...
              <div>
                ...
                <select 
                   ...
                   className="w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-blue-500 outline-none cursor-pointer"
              ...
              <div className="pt-4 flex justify-end gap-3 border-t border-slate-100 mt-6">
                ...
                <button type="submit" disabled={loading} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-bold shadow-md shadow-blue-200 transition-all">
