...
function AppContent() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-slate-50 font-sans">
      ...
      {/* Futuristic Sidebar */}
      <aside className={`fixed md:static top-0 bottom-0 left-0 z-50 transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-300 ease-out w-full md:w-64 bg-gradient-to-b from-[#050b18] via-[#081226] to-[#040812] border-r border-cyan-500/20 text-slate-300 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.6)] relative overflow-hidden select-none`}>
        ...
        <div className="p-5 pb-3 hidden md:block border-b border-slate-800/60 relative z-10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h1 className="text-2xl md:text-xl font-black text-white tracking-wider leading-none">tkip<span className="text-cyan-400">.net</span></h1>
                <p className="text-xs md:text-[10px] text-cyan-400/70 font-semibold tracking-widest uppercase mt-1">ISP Management</p>
              </div>
            </div>
            <span className="text-xs md:text-[9px] font-mono px-2 py-1 md:px-1.5 md:py-0.5 rounded bg-cyan-950/80 border border-cyan-500/30 text-cyan-400">v2.6</span>
          </div>
        </div>
        ...
        <nav className="flex-1 px-3 space-y-1 mt-1 overflow-y-auto no-scrollbar pb-6 relative z-10">
          ...
          {/* Section */}
          <div className="px-3 pt-4 pb-2 text-xs md:text-[10px] font-black text-slate-400 uppercase tracking-wider">
            Gestión
          </div>

          {/* 1. Dashboard */}
          <Link onClick={handleLinkClick} to="/" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {/* 2. Clientes */}
          {isAllowed('CLIENTES') && (
            <Link onClick={handleLinkClick} to="/clients" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/clients' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {isAllowed('FACTURACION') && (
            <Link onClick={handleLinkClick} to="/invoices" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/invoices' ? 'bg-blue-500/15 text-blue-300 border border-blue-500/30 shadow-[0_0_12px_rgba(59,130,246,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {/* Difusión */}
          <Link onClick={handleLinkClick} to="/broadcast" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/broadcast' ? 'bg-indigo-500/15 text-indigo-300 border border-indigo-500/30 shadow-[0_0_12px_rgba(99,102,241,0.2)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {/* Chat CRM */}
          <Link onClick={handleLinkClick} to="/chat" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/chat' ? 'bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 shadow-[0_0_12px_rgba(16,185,129,0.2)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {isAllowed('CORTES') && (
            <Link onClick={handleLinkClick} to="/cutoff" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/cutoff' ? 'bg-rose-500/15 text-rose-300 border border-rose-500/30 shadow-[0_0_12px_rgba(244,63,94,0.2)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {isAllowed('CAJA') && (
            <>
              <Link onClick={handleLinkClick} to="/cash" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/cash' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
              ...
              <Link onClick={handleLinkClick} to="/pos" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/pos' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {/* 9. Reportes */}
          {isAllowed('REPORTES') && (
            <Link onClick={handleLinkClick} to="/unidentified" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/unidentified' ? 'bg-amber-500/15 text-amber-300 border border-amber-500/30 shadow-[0_0_12px_rgba(245,158,11,0.2)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {/* 10. Soporte Técnico */}
          {isAllowed('SOPORTE') && (
            <Link onClick={handleLinkClick} to="/tickets" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/tickets' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {/* 11. Altas Web/Agente */}
          {isAllowed('CLIENTES') && (
            <Link onClick={handleLinkClick} to="/altas-web" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/altas-web' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {/* 13. Contenido */}
          {isAllowed('CLIENTES') && (
            <Link onClick={handleLinkClick} to="/content-approval" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/content-approval' ? 'bg-indigo-500/15 text-indigo-300 border border-indigo-500/30 shadow-[0_0_12px_rgba(99,102,241,0.2)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {isAllowed('BAJAS') && (
            <Link onClick={handleLinkClick} to="/bajas" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/bajas' ? 'bg-rose-500/15 text-rose-300 border border-rose-500/30 shadow-[0_0_12px_rgba(244,63,94,0.2)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {isAllowed('BAJAS') && (
            <Link onClick={handleLinkClick} to="/retiros" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/retiros' ? 'bg-orange-500/15 text-orange-300 border border-orange-500/30 shadow-[0_0_12px_rgba(249,115,22,0.2)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {/* Planes (Admin) */}
          {isAllowed('PLANES') && (
            <Link onClick={handleLinkClick} to="/plans" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/plans' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
          ...
          {user.role === 'ADMIN' && (
            <>
              <Link onClick={handleLinkClick} to="/users" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/users' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
              ...
              <Link onClick={handleLinkClick} to="/whatsapp" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/whatsapp' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
              ...
              <Link onClick={handleLinkClick} to="/nodes" className={`group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium ${location.pathname==='/nodes' ? 'bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 shadow-[0_0_12px_rgba(6,182,212,0.15)] font-semibold' : 'text-slate-400 hover:text-slate-100 hover:bg-white/[0.04] border border-transparent'}`}>
              ...
              <Link onClick={handleLinkClick} to="/portal" target="_blank" className="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-base md:text-sm font-medium text-emerald-400 hover:text-emerald-200 hover:bg-emerald-500/10 border border-emerald-500/20 shadow-[0_0_10px_rgba(16,185,129,0.15)]">
